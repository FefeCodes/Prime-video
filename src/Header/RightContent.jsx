...
export default function RightContent() {
  return (
    <div className="flex gap-4 items-center text-sm md:text-base font-medium w-fit md:w-auto justify-end">
      ...
      <button className="bg-blue-600 text-white px-3 py-1.5 md:px-4 md:py-2 rounded-md cursor-pointer text-sm md:text-sm font-medium hover:bg-blue-700 transition hidden md:flex">
        Join Prime
      </button>
    </div>
  );
